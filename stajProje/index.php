...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <img src="<?php echo $resimler; ?>" alt="<?php echo $resimAlt; ?>" width="<?php echo $genislik;
    50 ?>" height="<?php echo $yukseklik;
    50 ?>">
    </body>
    </html>
    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col" style="margin-top:10px">
                ...
                <img src="resimler/zz.png" class=""
                     style="width: 120px; height: 100px; position: relative; top: -15px; left: 10px;">
                ...
                <form class="row g-3" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="kullaniciadi" class="form-control" id="inputAddress"
            ...
            <div class="col">
                ...
                <img src="resimler/kedi.png" class=""
                     style="width:120px; height:110px;position: relative; top: -15px; left: 10px;">
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="email" id="exampleInputEmail1"
                               aria-describedby="emailHelp" placeholder="ornek@gmail.com">
                        <div id="emailHelp" class="form-text">E-Postanız kimseyle paylaşılmaz. Detaylı bilgi kullanıcı
                            sözleşmesidir.
                        </div>
                    </div>
                    <div class="mb-3">
